...
# frequency file produced by QE's matdyn.x (flfrq in matdyn.x input) and,
# optinally a k-path definition file which maps q-points to special point
# names. See pwscf.parse_dis() and read_matdyn_freq().
...
if __name__ == '__main__':
    ...
    # usage:
    #   plot_dispersion.py matdyn.freq [kpath_def.txt]
